...
@Component({
  selector: 'app-selled-product',
  templateUrl: './selled-product.component.html',
  styleUrls: ['./selled-product.component.scss']
})
export class SelledProductComponent implements OnInit {
